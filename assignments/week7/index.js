...
.then(response => {
    ...
    checkbox.addEventListener("click", (event) => {
        ...
        axios.put("https://api.vschool.io/[april_w]/todo/" + event.currentTarget.id, {completed:updates})
    ...
    button.addEventListener("click", (event) => {
        axios.delete("https://api.vschool.io/[april_w]/todo/" + event.currentTarget.id)
            .then(response => {response.data
            location.reload()
            })
            .catch(error => console.log(error))
    ...
    submits.addEventListener("click", (event) => {
        ...
        axios.put("https://api.vschool.io/[april_w]/todo/" + event.currentTarget.id, {
            title:t,
            description:d,
            price:p
            })
